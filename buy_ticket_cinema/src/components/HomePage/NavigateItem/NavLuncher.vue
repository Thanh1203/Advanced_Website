    ...
    <div class="navLuncher_ctn">
        <div class="navLuncher_social">
            ...
            <div class="navLuncher_fb">
                <a href="https://www.facebook.com/LotteCinema" class="txt_link" target="_blank" >
        ...
        <div class="navLuncher_login_user">
            <p class="nav_change-txt" v-show="!isLogin" @click="goToLogin">Đăng nhập</p>
            <p class="nav_change-txt" v-show="isLogin" @click="logout">Đăng xuất</p>
            <p class="nav_change-txt" v-show="isLogin" @click="goUserInfo">Tài khoản của tôi</p>
